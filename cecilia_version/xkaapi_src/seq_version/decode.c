...
{
  decode_arg_t* arg0 = (decode_arg_t*) taskarg;

  frame_chunk_t* chunk = arg0->chunk;
...
//  t2 = kaapi_get_elapsedns();
  ...
  GET_TICK (t1_2);
#endif
  resize_arg_t* resize_args = (resize_arg_t*) malloc (sizeof (resize_arg_t));
  resize_args->chunk =  chunk;
  resize_body (resize_args);
#ifdef C2X_USES_TIMING
  GET_TICK (t2_2);
  wq_time_table[tid].tpush += TICK_RAW_DIFF(t1_2,t2_2);
#endif
  }
