...
int main (void) {
	...
	// Component: fetch
	component *fetch = createComponent(10, "fetch", fetch_process);
	...
	// Component: compute0
	component *compute0 = createComponent (20, "compute0", idct_process);
	...
	// Component: compute1
	component *compute1 = createComponent (21, "compute1", idct_process);
	...
	// Component: compute2
	component *compute2 = createComponent (22, "compute2", idct_process);
	...
	// Component: dispatch
	component *dispatch = createComponent (30, "dispatch", dispatch_process);
	...
	// Component: Observer
	component *observer = createComponent(900, "observer", observer_function);
